...
XXX::XXX(const XXX& xxx) {
    ...
    name_ = new char[sz];
    strcpy(name_,xxx.name_); //kopjuije pamiec z jedengo do drugiego
    //Teraz nowy obiekt pokazuje na nowy fragment pamięci,
    //ale ze skopiowaną informacją
}
//operator przypisania: (sprawdzic czy nie jest tym sasmym, zdealokowac pamiec this, i przekazac pamiec nowemu
...
XXX::XXX(XXX &&xxx) : name_{nullptr} { //nie musi byc w liscie inicjalizacyjnej
